...
defined('MOODLE_INTERNAL') || die();
   ...
   function mod_moodlecst_slidepair_delete_item($moodlecst, $itemid, $context) {
		global $DB;
		$ret = false;
		
        if (!$DB->delete_records(MOD_MOODLECST_SLIDEPAIR_TABLE, array('id'=>$itemid))){
		...
		$fileareas = array(MOD_MOODLECST_SLIDEPAIR_TEXTQUESTION_FILEAREA,
		MOD_MOODLECST_SLIDEPAIR_TEXTANSWER_FILEAREA . '1',
		MOD_MOODLECST_SLIDEPAIR_TEXTANSWER_FILEAREA . '2',
		MOD_MOODLECST_SLIDEPAIR_TEXTANSWER_FILEAREA . '3',
		MOD_MOODLECST_SLIDEPAIR_TEXTANSWER_FILEAREA . '4',
		MOD_MOODLECST_SLIDEPAIR_AUDIOQUESTION_FILEAREA,
	...
	function mod_moodlecst_slidepair_fetch_editor_options($course, $modulecontext){
		$maxfiles=99;
