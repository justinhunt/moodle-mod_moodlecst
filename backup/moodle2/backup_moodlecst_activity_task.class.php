...
require_once($CFG->dirroot . '/mod/moodlecst/backup/moodle2/backup_moodlecst_stepslib.php');

/**
 * Provides all the settings and steps to perform one complete backup of englishcentral activity
 */
class backup_moodlecst_activity_task extends backup_activity_task {
    ...
    protected function define_my_steps() {
        $this->add_step(new backup_moodlecst_activity_structure_step('moodlecst_structure', 'moodlecst.xml'));
    }
